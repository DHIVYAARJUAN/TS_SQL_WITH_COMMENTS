-- VERSION 0.1 STARTDATE:01/10/2014 ENDDATE:01/10/2014 ISSUE NO:91 COMMENT NO:1  DESC:SP FOR INSERT INTO EMPLOYEE DETAILS FOLLOWED BY COMPANY PROPERTIES DETAILS. DONE BY :RAJA
...
END;
/*
CALL SP_TS_EMPLOYEE_AND_COMPANY_PROPERTIES_DETAILS_INSERT('dhivya.arjunan@ssomens.com','DHIVYA','ARJUNAN','1991-03-04','PROGRAMMER','8608502941','DIV','STAFF','8608502941',
'56TRGHY5E6T4EWRW','23RWEFDSF3WREWF332','X','X','X','','','dhandapani.sattanathan@ssomens.com',@SUCCESS_FLAG);
SELECT @SUCCESS_FLAG;
*/